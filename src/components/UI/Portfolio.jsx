    ...
    <div className='container'>
        ...
        <div className='flex items-center gap-4 flex-wrap mt-12'>
            {portfolios?.slice(0,nextItems)?.map((portfolio,index)=>(
                <div key={index} data-aos="fade-zoom-in" data-aos-delay="50" data-aos-duration="1000" className='group max-w-full sm:w-[48.5%]
        ...
        <div className='text-center mt-6'>
            {
                ...
                className='text-white bg-primaryColor hover:bg-smalltextColor py-2 px-4
                rounded-[8px] font-[500] ease-in duration-200'>Load More</button>
            }
