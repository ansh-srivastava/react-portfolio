    ...
    <section id="services">
        <div className='container lg:pt-5'>
            <div className='text-center'>
                ...
                doloribus? Quas perferendis ipsam esse repudiandae ullam voluptate nemo,
                iure sint, ex nostrum voluptatum minima repellat? 
                            ...
                            <div className='w-full sm:w-1/2 sm:pr-8'>
                                <div data-aos="fade-right" data-aos-duration='1200' className='bg-white p-4 rounded shadow group
                                 hover:bg-primaryColor cursor-pointer ease-in duration-150'>
                                    ...
                                    group-hover:font-[500] leading-7'>Lorem, ipsum dolor sit amet consectetur adipisicing elit 
                                    Officiis esse est eos accusantium hic tempora voluptatum illum,
                                    exercitationem saepe ratione.</p>
                                 </div>
                            </div>
                        </div>
